...
const Autoexcludere: React.FC = () => {
    ...
    return (
        <div className="autoexcludere-container">
            ...
            <p>Ești sigur că vrei să te auto-excluzi? Această acțiune va crea o cerere care trebuie aprobată de un admin. După aprobare, contul tău va fi dezactivat, și nu vei mai putea paria până când un admin îți reactivează contul.</p>
